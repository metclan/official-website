    ...
    <section className="relative mb-20 w-[90%] mx-auto mt-20">
      ...
      <div className="mt-14 md:mt-20">
        ...
        <p className="my-5 md:w-2/3">
          ...
          are close to their expiration date. It's not just about tracking; this
          tool also does the math for you, helping you figure out your profits
          and losses. Running low on a popular product? Stocksavvy gives you a
          heads-up so you can restock before it's too late. And if you're
          managing multiple locations, no worries – Stocksavvy is your go-to
          solution for seamless tracking across all your spots.
        </p>
      </div>
      <Image
      ...
      <div className="flex justify-between mt-16 gap-10 md:flex-row flex-col">
        <div className="flex-1">
          ...
          <p className="text-sm mt-2 leading-relaxed">
            ...
            money. It's like a special detective friend that helps you find out
            why this is happening. Maybe you're buying too many of one thing, or
            someone who works with you is doing something wrong. Stocksavvy,
            your special friend, also tells you how much all your things in the
            store are worth. It's like having a magic helper, Stocksavvy, that
            makes sure your store is doing great!
          </p>
        </div>
        <Image
      ...
      <div className="flex justify-between mt-10 gap-10 md:flex-row flex-col">
        ...
        <div className="flex-1 order-first md:order-last">
          ...
          <p className="text-sm mt-2 leading-relaxed">
            As the boss of your business, it's super important to know all about
            your stock report. This report tells you how much money you used to
            buy all your stuff, how much money you could get by selling
      ...
      <div className="flex justify-between mt-16 gap-10 md:flex-row flex-col">
        <div className="flex-1 order-first md:order-last">
          ...
          <p className="text-sm mt-2 leading-relaxed">
            Stocksavvy is like a super assistant for you and your team when it's
            time to wrap up the day. Instead of spending a lot of time with pen
            and paper, Stocksavvy gives you a special report. This report tells
            you everything you need to know, like how much stuff you sold for
            the day, how much money you got in cash, through the bank, pos and
            from card payments. It even adds up all your sales to give you a big
            total! This saves a ton of time and makes sure everything adds up
            correctly at the end of the day. Super handy, right?
          </p>
        </div>
        <Image
          src={"/images/eod.png"}
